(function () {
  ...
  const exactFr = new Map(Object.entries({
    ...
    "Onze acties": "Nos promotions",
    "SHOWROOMMODELLEN": "MODÈLES D’EXPOSITION",
    "Showroommodellen | Sunspa Catalogus": "Modèles d’exposition | Catalogue Sunspa",
    "Showroommodel": "Modèle d’exposition",
    "Showroommodel · pakketprijs": "Modèle d’exposition · prix du pack",
    "Showroomkorting": "Remise modèle d’exposition",
    "Levering in overleg": "Livraison à convenir",
    "In overleg": "À convenir",
    "Inclusief levering & installatie, cover & trap, coverlift en Spa Balancer pakket.": "Livraison et installation, couverture et escalier, lève-couverture et pack Spa Balancer inclus.",
    ...
    "ACTIE OP MYSPA & VOGUE": "PROMOTION SUR MYSPA & VOGUE",
    "Op alle MySpa spa's wordt tijdelijk € 1.000,00 korting verrekend. Op alle Vogue modellen geldt tijdelijk 11% korting op de originele prijs.": "Sur tous les spas MySpa, une remise temporaire de 1 000,00 € est déduite. Tous les modèles Vogue bénéficient temporairement de 11 % de remise sur le prix d'origine.",
    "MySpa en Vogue actie": "Promotion MySpa et Vogue",
    "ACTIES OP SPA'S": "PROMOTIONS SUR LES SPAS",
    "Op alle MySpa spa's wordt tijdelijk € 1.000,00 korting verrekend. Op alle Vogue modellen geldt tijdelijk 11% korting. Voor Bullfrog staan de actuele actieprijzen per model direct verwerkt.": "Sur tous les spas MySpa, une remise temporaire de 1 000,00 € est déduite. Tous les modèles Vogue bénéficient temporairement de 11 % de remise. Pour Bullfrog, les prix promotionnels actuels sont directement intégrés par modèle.",
    "Spa acties": "Promotions spas",
    "Alle MySpa spa's": "Tous les spas MySpa",
    "Alle Vogue modellen": "Tous les modèles Vogue",
    "Bullfrog actieprijzen": "Prix promotionnels Bullfrog",
    ...
    "Bekijk onze Vogue modellen": "Voir nos modèles Vogue",
    "Bekijk onze Bullfrog modellen": "Voir nos modèles Bullfrog",
    ...
    "MySpa & Vogue actie": "Promotion MySpa & Vogue",
    "Direct voordeel op de originele prijs": "Avantage direct sur le prix d'origine",
    "MySpa krijgt € 1.000,00 korting. Vogue krijgt 11% korting.": "MySpa bénéficie de 1 000,00 € de remise. Vogue bénéficie de 11 % de remise.",
    "MySpa krijgt € 1.000,00 korting. Vogue krijgt 11% korting. Bullfrog actieprijzen verschillen per model.": "MySpa bénéficie de 1 000,00 € de remise. Vogue bénéficie de 11 % de remise. Les prix promotionnels Bullfrog varient selon le modèle.",
