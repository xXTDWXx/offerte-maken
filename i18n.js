(function () {
  ...
  const exactFr = new Map(Object.entries({
    ...
    "21% BTW ACTIE OP MYSPA": "PROMOTION TVA 21 % SUR MYSPA",
    "Op alle MySpa spa's wordt de 21% btw tijdelijk als korting verrekend.": "Sur tous les spas MySpa, la TVA de 21 % est temporairement déduite sous forme de remise.",
    "MySpa 21% btw actie": "Promotion TVA 21 % MySpa",
    ...
    "Betaal tijdelijk de prijs zonder 21% btw": "Payez temporairement le prix hors TVA 21 %",
    "De korting is het verschil tussen de beginprijs en de beginprijs gedeeld door 1,21.": "La remise correspond à la différence entre le prix de départ et ce même prix divisé par 1,21.",
